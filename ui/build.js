  ...
  "x-flows": [
      ...
      steps: [
        {
                  ...
                  orders: [
                    {
                      id: "ordr-123456",
                      inter_participant: {
                        amount: { currency: "INR", value: "1000.12" },
                      },
                      collector: {
          ...
          details: [
            {
              description:
                "settlement instructions from NP to Settlement Agency",
              mermaid:
                  ...
                  orders: [
                    {
                      id: "ordr-123456",
                      inter_participant: {
                        amount: { currency: "INR", value: "1000.00" },
                      },
                      collector: {
                        amount: { currency: "INR", value: "50.00" },
                      },
                      self: { amount: { currency: "INR", value: "50.00" } },
                    },
                  ],
                },
              },
    ...
    },
    {
      ...
      details: [
        {
          description:
            "Detailed flows covering miscellaneous or self settlements.  NPs share settlement instructions to the Settlement Agency  and the settlement agency responds with whether the settlement  was successful or not. In the example below, a retail seller app is sharing settlement instructions to move funds from their non operating account to their operating account and their respective provider's account.",
          mermaid:
    ...
    },
    {
      ...
      details: [
        {
          description:
            "Detailed flows covering the NPs declaring that no settlements (where they would act as a collector) are to be done for that settlement cycle.",
          mermaid:
          ...
          example: {
            value: {
              context: {
                ...
                bap_id: "collectorapp.com",
                bap_uri: "https://collectorapp.com/ondc/1.0/",
                bpp_id: "sa_nocs_abcd.nbbl.com",
                bpp_uri: "https://sa_nocs_abcd.nbbl.com/nocs_test",
                transaction_id: "dc34a366-aebb-4144-9314-808dda82c7e6",
                message_id: "941ed9a4-d74d-4411-ac06-469c0f9ac",
                timestamp: "2024-05-09T11:36:51.897Z",
                ttl: "P1D",
        ...
        },
        {
          ...
          example: {
            value: {
              ...
              error: { code: "70005", message: "Invalid bpp id" },
            },
          },
        },
      ],
        ...
        on_settle: {
          examples: [
            ...
            },
            {
              ...
              description:
                "callback response for Misc / self settlement instruction",
              value: {
                context: {
                  domain: "ONDC:NTS10",
                  location: { country: { code: "IND" }, city: { code: "*" } },
                    ...
                    orders: [
                      {
                        provider: {
                          id: "provider-id-789",
                          amount: { currency: "INR", value: "200.12" },
                          status: "NOT_SETTLED",
                          reference_no: "3718683618631",
                          error: { code: "01", message: "Account inactive" },
                        },
                ...
                provider: {
                  ...
                  bank_details: {
                    account_no: {
                      ...
                      owner: "any",
                      usage: 1234567890,
                      description: "Account number of the provider",
                    },
                    ifsc_code: {
                      required: true,
                      type: "string",
                      owner: "any",
                      usage: "IFSC0001",
                      description: "IFSC code of the provider",
                    },
                  },
                  amount: {
                    currency: {
                      ...
                      usage: "INR",
                      description:
                        "Currency of the amount that is to be transferred to the provider's provided account",
                    },
                    value: {
                      required: true,
                      type: "string",
                      ...
                      usage: "200.00",
                      description:
                        "Provider amount is the amount that is to be transferred to the provider's provided account",
                    },
                  },
                },
              },
              ...
              orders: {
                self: {
                  ...
                  reference_no: {
                    ...
                    owner: "any",
                    usage: "1238683618634",
                    description: "Reference number of self fund settlement",
                  },
                  error: {
                    code: {
                      required: true,
                ...
                provider: {
                  ...
                  reference_no: {
                    ...
                    owner: "any",
                    usage: "3718683618631",
                    description: "Reference number of provider fund settlement",
                  },
                  error: {
                    code: {
                      required: true,
                ...
                inter_participant: {
                  ...
                  reference_no: {
                    ...
                    usage: "3718683618631",
                    description:
                      "Reference number of Interparticipant fund settlement",
                  },
                  error: {
                    code: {
                      required: true,
            ...
            orders: {
              ...
              settlements: {
                ...
                settlement_ref_no: {
                  ...
                  owner: "any",
                  usage: "utr-1234",
                  description: "Settlement Reference number of the settlement ",
                },
                status: {
                  required: true,
                  type: "string",
